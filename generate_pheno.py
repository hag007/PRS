...
if __name__=="__main__":
    ...
    parser.add_argument('-pop', '--pop_path', dest='pop_path', help='', default=os.path.join(constants.DATASETS_PATH, "ukbb","pop.panel"))
    parser.add_argument('-pheno', '--pheno_path', dest='pheno_path', help="", default=os.path.join(constants.DATASETS_PATH, "ukbb","pheno"))
    parser.add_argument('-f', '--filters', dest='filters', default='{"pop": ["AFR"]}', help='')   # UR,BEB,PJL,MSL,ASW,ACB,CEU
