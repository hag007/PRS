...
if __name__=='__main__':
    ...
    parser.add_argument('-p', '--prs_names', dest='prs_names', help="", default="bcac_onco_eur-5pcs_bcac_onco_aj")
    ...
    parser.add_argument('-fn', '--file_name_format', dest='file_name_format', help="", default="prs.ls{}.or_summary_bcac_aj{}.tsv")
